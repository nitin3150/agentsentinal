...
# def _has_flag(profile: AgentProfile, category: RiskCategory) -> bool:
#     return any(f.category == category for f in profile.risk_flags)


# def _flags_as_text(profile: AgentProfile) -> str:
#     lines = []
...
# def _low_quality_tools(profile: AgentProfile) -> list[ToolProfile]:
...
#     reasoning:         str = dspy.OutputField(desc="Step-by-step reasoning for adding constraints")
...
#     reasoning:         str       = dspy.OutputField(desc="Step-by-step reasoning for replacing ambiguous phrases")
...
#     reasoning:       str = dspy.OutputField(desc="Step-by-step reasoning for adding scope clause")
...
#     """
#     original_prompt: str = dspy.InputField(desc="Current system prompt")
#     reasoning:       str = dspy.OutputField(desc="Step-by-step reasoning for adding uncertainty rules")
...
#     reasoning:         str = dspy.OutputField(desc="Step-by-step reasoning for adding injection defences")
...
#     """
#     original_prompt: str = dspy.InputField(desc="Current system prompt")
#     reasoning:       str = dspy.OutputField(desc="Step-by-step reasoning for rewriting persona")
...
#     company_policy:  str       = dspy.InputField(desc="Company policy document")
#     regulations:     str       = dspy.InputField(desc="Applicable government regulations")
#     reasoning:       str       = dspy.OutputField(desc="Step-by-step reasoning for adding memory rules")
...
#     reasoning:            str       = dspy.OutputField(desc="Step-by-step reasoning for rewriting tool description")
...
# # The forward method returns a dict with these keys:
# # - improved_prompt: str
...
#             r = self.fix_hallucination(original_prompt=prompt)
#             prompt = r.improved_prompt
...
#         try:
#             improved_profile: AgentProfile = asyncio.run(
...
#         original: AgentProfile = example.agent_profile
#         score = 0.0
...
#         def forward(self, original_prompt, tool_definitions, agent_profile):
...
# # ─────────────────────────────────────────────────────────────────────────────
# # 7.  QUICK DEMO  (mirrors demo/test_inspector.py exactly)
# # ─────────────────────────────────────────────────────────────────────────────
